...
public class MainApp {
    public static void main(String[] args) throws SQLException {
        ...
        carService.add(new Car("BMW", 8));
        carService.add(new Car("Audi", 90));
        carService.add(new Car("Mercedes", 200));
        carService.add(new Car("Chevrolet", 147));
        ...
        System.out.println(userService.find("BMW", 8));
        context.close();
    }
}
